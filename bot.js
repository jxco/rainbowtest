...
client.on('ready', async () => {
    let rSpeed = 4; 
    let rGuild = '503647749317853196'; // اي دي السيرفر 
    let rRole = '503920639455920138'; // اي دي الرتبة تجيبه عن طريق انك تفعل خاصية ان اي واحد يقدر يمنشن الرتبة و تمنشن الرتبة بالشات وقبل ما تمنشنها حط \
    /* مثال :
    \@TestingRole
    الناتج :
    <@&12345678987654321>
