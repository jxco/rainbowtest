...
client.on('ready', async () => {
    let rSpeed = 5; 
    let rGuild = '509776845328089088'; // اي دي السيرفر 
    let rRole = '509777314176040980'; // اي دي الرتبة تجيبه عن طريق انك تفعل خاصية ان اي واحد يقدر يمنشن الرتبة و تمنشن الرتبة بالشات وقبل ما تمنشنها حط \
    /* مثال :
    \@TestingRole
    الناتج :
    <@&12345678987654321>
